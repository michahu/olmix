...
def draw_olmixbase_call(
    ...
    # left label
    ax.text(center_x - total_w / 2 - 3.5, center_y, title_left, ha="left", va="center", fontsize=18, color=BLACK)

    # left parenthesis
    ax.text(x_blocks_left - 0.55, center_y, "(", ha="center", va="center", fontsize=32, color=BLACK)
    ...
    # right parenthesis
    ax.text(x_right + 0.55, center_y, ")", ha="center", va="center", fontsize=32, color=BLACK)
...
def build_figure() -> plt.Figure:
    ...
    fig, ax = plt.subplots(figsize=(12.5, 6.3), dpi=1000)
    ax.set_xlim(0, 36)
    ax.set_ylim(0, 16)
    ...
    # -----------------------------
    ax.text(x_left, y_mid_titles, "Full recomputation", ha="center", va="center", fontsize=22, color=BLACK)
    ax.text(x_mid, y_mid_titles, "Partial mixture reuse", ha="center", va="center", fontsize=22, color=BLACK)
    ax.text(x_right, y_mid_titles, "Full mixture reuse", ha="center", va="center", fontsize=22, color=BLACK)
    ...
    ax.text(32.0, y_bottom + 1.2, "Lower cost", ha="left", va="center", fontsize=18, color=BLACK)
    ax.text(24.0, y_bottom - 1.2, "Potentially lower performance", ha="left", va="center", fontsize=18, color=BLACK)
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=Path("fig_mixreuse.pdf"))
